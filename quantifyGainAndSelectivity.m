...
subplot = @(m,n,p) subtightplot (m, n, p, [0.08 0.08], [0.05 0.06], [0.05 0.02]);
subplot(2,2,1)
plot(-800:50:0,L23gainData,'color',[0 0 0]+alpha)
hold on
plot(-800:50:0,mean(L23gainData,2),'linewidth',3,'color',[0 0 0])
...
subplot(2,2,2)
plot(-800:50:0,L4gainData,'color',[0 0 0]+alpha)
hold on
plot(-800:50:0,mean(L4gainData,2),'linewidth',3,'color',[0 0 0])
plot(-800:50:0,zeros(17,1),'k--')
title('Layer 4')
xlabel('Laser onset (relative to tone)')
ylabel('Gain')
...
subplot(2,2,3)
plot(-800:50:0,L5gainData,'color',[0 0 0]+alpha)
hold on
plot(-800:50:0,mean(L5gainData,2),'linewidth',3,'color',[0 0 0])
plot(-800:50:0,zeros(17,1),'k--')
title('Layer 5')
xlabel('Laser onset (relative to tone)')
ylabel('Gain')
...
subplot(2,2,4)
plot(-800:50:0,L6gainData,'color',[0 0 0]+alpha)
hold on
plot(-800:50:0,mean(L6gainData,2),'linewidth',3,'color',[0 0 0])
plot(-800:50:0,zeros(17,1),'k--')
title('Layer 6')
xlabel('Laser onset (relative to tone)')
ylabel('Gain')
